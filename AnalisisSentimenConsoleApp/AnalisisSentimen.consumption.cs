...
namespace AnalisisSentimenConsoleApp
{
    ...
    {
        /// <summary>
        /// model input class for AnalisisSentimen.
        /// </summary>
        ...
        public class ModelInput
        {
            ...
            public float Class_label { get; set; }
        ...
        /// <summary>
        /// model output class for AnalisisSentimen.
        /// </summary>
        #region model output class
        public class ModelOutput
        {
            [ColumnName(@"class_label")]
            public uint Class_label { get; set; }
        ...
        private static string MLNetModelPath = Path.GetFullPath("AnalisisSentimen.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("class_label");
            if (labelColumn == null)
            {
                throw new Exception("class_label column not found. Make sure the name searched for matches the name in the schema.");
            }
