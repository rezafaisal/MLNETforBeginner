...
namespace AnalisisSentimenConsoleApp
{
    public partial class AnalisisSentimen
    {
        public const string RetrainFilePath =  @"C:\Data\My Books\INDC - ML.NET with NET 9\code\BeginnerMLNET\TextClassification\data\film_indonesia.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"class_label",inputColumnName:@"class_label",addKeyValueAnnotationsAsText:false)      
                                    .Append(mlContext.MulticlassClassification.Trainers.TextClassification(labelColumnName: @"class_label", sentence1ColumnName: @"text"))      
