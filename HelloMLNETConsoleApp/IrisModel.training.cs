...
namespace HelloMLNETConsoleApp
{
    public partial class IrisModel
    {
        public const string RetrainFilePath =  @"C:\Data\My Books\INDC - MLNET\code\BeginnerMLNET\HelloMLNET\data\iris-train.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"Sepal length", @"Sepal length"),new InputOutputColumnPair(@"Sepal width", @"Sepal width"),new InputOutputColumnPair(@"Petal length", @"Petal length"),new InputOutputColumnPair(@"Petal width", @"Petal width")})      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.8644929F,L2Regularization=0.3123275F,LabelColumnName=@"#Label",FeatureColumnName=@"Features"}))      
